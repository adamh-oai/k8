...
class IoExternalSecretsV1alpha1SecretStoreSpecProviderAwsAuthSecretRef(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accessKeyIDSecretRef", "secretAccessKeySecretRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoExternalSecretsV1alpha1SecretStoreSpecProviderAwsAuthSecretRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoExternalSecretsV1alpha1SecretStoreSpecProviderAwsAuthSecretRef from a dict"""
        if obj is None:
            return None
