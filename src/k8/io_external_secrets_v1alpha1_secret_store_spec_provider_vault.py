...
from .io_external_secrets_v1alpha1_secret_store_spec_provider_vault_auth import IoExternalSecretsV1alpha1SecretStoreSpecProviderVaultAuth
from .io_external_secrets_v1alpha1_secret_store_spec_provider_vault_ca_provider import IoExternalSecretsV1alpha1SecretStoreSpecProviderVaultCaProvider
from typing import Optional, Set
from typing_extensions import Self

class IoExternalSecretsV1alpha1SecretStoreSpecProviderVault(BaseModel):
    """
    Vault configures this store to sync secrets using Hashi provider
    """ # noqa: E501
    auth: IoExternalSecretsV1alpha1SecretStoreSpecProviderVaultAuth
    ...
    ca_provider: Optional[IoExternalSecretsV1alpha1SecretStoreSpecProviderVaultCaProvider] = Field(default=None, alias="caProvider")
    ...
    __properties: ClassVar[List[str]] = ["auth", "caBundle", "caProvider", "forwardInconsistent", "namespace", "path", "readYourWrites", "server", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoExternalSecretsV1alpha1SecretStoreSpecProviderVault from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoExternalSecretsV1alpha1SecretStoreSpecProviderVault from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "auth": IoExternalSecretsV1alpha1SecretStoreSpecProviderVaultAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None,
            "caBundle": obj.get("caBundle"),
            "caProvider": IoExternalSecretsV1alpha1SecretStoreSpecProviderVaultCaProvider.from_dict(obj["caProvider"]) if obj.get("caProvider") is not None else None,
