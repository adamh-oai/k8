...
from .io_external_secrets_v1beta1_secret_store_spec_provider_oracle_auth import IoExternalSecretsV1beta1SecretStoreSpecProviderOracleAuth
from typing import Optional, Set
from typing_extensions import Self

class IoExternalSecretsV1beta1SecretStoreSpecProviderOracle(BaseModel):
    """
    Oracle configures this store to sync secrets using Oracle Vault provider
    """ # noqa: E501
    auth: Optional[IoExternalSecretsV1beta1SecretStoreSpecProviderOracleAuth] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoExternalSecretsV1beta1SecretStoreSpecProviderOracle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoExternalSecretsV1beta1SecretStoreSpecProviderOracle from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "auth": IoExternalSecretsV1beta1SecretStoreSpecProviderOracleAuth.from_dict(obj["auth"]) if obj.get("auth") is not None else None,
