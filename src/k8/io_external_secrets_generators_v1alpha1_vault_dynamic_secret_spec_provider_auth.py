...
from .io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth_app_role import IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthAppRole
...
from .io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth_iam import IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthIam
from .io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth_jwt import IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthJwt
...
from .io_external_secrets_generators_v1alpha1_vault_dynamic_secret_spec_provider_auth_user_pass import IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthUserPass
from typing import Optional, Set
from typing_extensions import Self

class IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth(BaseModel):
    """
    Auth configures how secret-manager authenticates with the Vault server.
    """ # noqa: E501
    app_role: Optional[IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthAppRole] = Field(default=None, alias="appRole")
    cert: Optional[IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthCert] = None
    iam: Optional[IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthIam] = None
    jwt: Optional[IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthJwt] = None
    ...
    user_pass: Optional[IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthUserPass] = Field(default=None, alias="userPass")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["appRole", "cert", "iam", "jwt", "kubernetes", "ldap", "namespace", "tokenSecretRef", "userPass"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of user_pass
        if self.user_pass:
            _dict['userPass'] = self.user_pass.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuth from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "appRole": IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthAppRole.from_dict(obj["appRole"]) if obj.get("appRole") is not None else None,
            ...
            "iam": IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthIam.from_dict(obj["iam"]) if obj.get("iam") is not None else None,
            "jwt": IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthJwt.from_dict(obj["jwt"]) if obj.get("jwt") is not None else None,
            ...
            "userPass": IoExternalSecretsGeneratorsV1alpha1VaultDynamicSecretSpecProviderAuthUserPass.from_dict(obj["userPass"]) if obj.get("userPass") is not None else None
        })
