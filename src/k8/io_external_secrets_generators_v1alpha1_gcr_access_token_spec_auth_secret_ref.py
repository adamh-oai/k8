...
class IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpecAuthSecretRef(BaseModel):
    """
    IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpecAuthSecretRef
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["secretAccessKeySecretRef"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpecAuthSecretRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoExternalSecretsGeneratorsV1alpha1GCRAccessTokenSpecAuthSecretRef from a dict"""
        if obj is None:
            return None
