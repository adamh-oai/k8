...
from .io_external_secrets_generators_v1alpha1_password_spec import IoExternalSecretsGeneratorsV1alpha1PasswordSpec
from .io_k8s_apimachinery_pkg_apis_meta_v1_object_meta import IoK8sApimachineryPkgApisMetaV1ObjectMeta
from typing import Optional, Set
from typing_extensions import Self

class IoExternalSecretsGeneratorsV1alpha1Password(BaseModel):
    """
    ...
    spec: Optional[IoExternalSecretsGeneratorsV1alpha1PasswordSpec] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoExternalSecretsGeneratorsV1alpha1Password from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoExternalSecretsGeneratorsV1alpha1Password from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoExternalSecretsGeneratorsV1alpha1PasswordSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
